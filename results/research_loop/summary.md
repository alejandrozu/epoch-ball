...
- Next step: Leave slice-preserving/common-left-factor affine transvection folds. The next live family should target pre-mixing before the fold or a genuinely nonlinear multi-stage local model, since those are the remaining ways to de
